...
public class C04_Immutable {
    public static void main(String[] args) {
        ...
        en meshur mutable class: StringBuilder
        ...
        str.substring(3,5);//sout olmadigindan  -di- yazdirmaz

        System.out.println(str);//Yildiz Bank


        // Java'da String gibi metin ifadelerde kullanabilecegimiz mutable StringBuilder class'i vardir
