...
public class C03_VarargsIleToplama {
    ...
    public static void toplaYazdir(int...sayi){
        /*
        int ... sayi    bu gosterim integer variables'lardan olusan bir varargs demektir
        varargs array alt yapisini kullanir
         */
        int toplam=0;
        int sayiAdedi= sayi.length;//------------->>>>>>sayi array alt yapisini kullandigi icin burada lenght yazdik
        for (int each:sayi) {
            toplam+=each;
